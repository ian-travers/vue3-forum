...
export default {
  ...
  actions: {
    async createPost ({ commit, state, rootState }, post) {
      ...
      post.firstInTread = post.firstInTread || false
      ...
      if (!post.firstInTread) threadUpdates.contributors = firebase.firestore.FieldValue.arrayUnion(rootState.auth.authId)
